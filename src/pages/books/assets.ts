...
export const heroBooks: BookCover[] = [
  {
    ...
    age: 'Kids',
    accent: '#F59E0B',
    cover: '/images/books/every_offering_pointed_to_him(kids_version).png'
  },
  {
    id: 'teen',
    title: 'Teen',
    ...
    age: 'Teen',
    accent: '#3B82F6',
    cover: '/images/books/every_offering_pointed_to_him(teen_version).png'
  },
  {
    id: 'adult',
    title: 'Adult',
...
export const collections: Collection[] = [
  ...
  },
  {
    ...
    cover: '/images/books/in_the_begining_he_was_there(kids_).png'
  },
  {
    id: 'torah-2',
  ...
  },
  {
    ...
    cover: '/images/books/he_spoke_before_he_came(complete_series).png'
  },
];
...
export const ageCards: AgeCard[] = [
  {
    ...
    cover: '/images/books/everywhere_i_look_its_him(kids_version).png'
  },
  {
    id: 'teen-card',
    age: 'Teen',
    ...
    cover: '/images/books/in_the_begining_he_was_there(teen_version) copy.png'
  },
  {
    id: 'adult-card',
    age: 'Adult',
