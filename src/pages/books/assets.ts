...
export const heroBooks: BookCover[] = [
  ...
  },
  {
    ...
    age: 'Teen',
    accent: '#3B82F6',
    cover: '/images/books/every_offering_pointed_to_him_teen.png',
  },
  {
    id: 'adult',
    title: 'Adult Edition',
    ...
    age: 'Adult',
    accent: '#D4AF37',
    cover: '/images/books/in_the_beginning_he_was_there_adult.png',
  },
];
...
export const collections: Collection[] = [
  {
    ...
    kidsCover: '/images/books/he_was_always_the_answer_kids.png',
    teenCover: '/images/books/he_was_always_the_answer_teen.png',
    adultCover: '/images/books/he_was_always_the_answer_adult.png',
  },
  {
    id: 'torah-1',
    ...
    cover: '/images/books/in_the_beginning_he_was_there_adult.png',
    kidsCover: '/images/books/in_the_beginning_he_was_there_kids.png',
    teenCover: '/images/books/in_the_beginning_he_was_there_teen.png',
    adultCover: '/images/books/in_the_beginning_he_was_there_adult.png',
  },
  {
    id: 'torah-2',
    ...
    kidsCover: '/images/books/every_offering_pointed_to_him_kids.png',
    teenCover: '/images/books/every_offering_pointed_to_him_teen.png',
    adultCover: '/images/books/every_offering_pointed_to_him_adult.png',
  },
  {
    id: 'psalms',
    volume: 'Psalms',
    ...
    kidsCover: '/images/books/he_sang_about_himself_kids.png',
    teenCover: '/images/books/he_sang_about_himself_teen.png',
    adultCover: '/images/books/he_sang_about_himself_adult.png',
  },
  {
    id: 'nt',
    ...
    kidsCover: '/images/books/everywhere_i_look_its_him_kids.png',
    teenCover: '/images/books/everywhere_i_look_its_him_teen.png',
    adultCover: '/images/books/everywhere_i_look_its_him_adult.png',
  },
  {
    id: 'deut',
    volume: 'Deuteronomy',
    ...
    kidsCover: '/images/books/he_spoke_before_he_came_kids.png',
    teenCover: '/images/books/he_spoke_before_he_came_teen.png',
    adultCover: '/images/books/he_spoke_before_he_came_adult.png',
  },
];
