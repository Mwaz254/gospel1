  ...
  return (
    <div className="overflow-x-hidden">
      <section className="relative pt-32 pb-24 bg-navy-700 overflow-hidden" aria-label="Prayer partners hero">
        <div className="absolute inset-0 bg-cover bg-center" aria-hidden="true" style={{ backgroundImage: "url('https://images.pexels.com/photos/6340685/pexels-photo-6340685.jpeg?auto=compress&cs=tinysrgb&w=1920')", opacity: 0.2 }} />
